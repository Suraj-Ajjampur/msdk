...
{
    //APP_TRACE_INFO0(" ----------- datsWpWriteCback ------------- \n\r");
    if (len < 64) {
...
uint8_t secDatWriteCback(dmConnId_t connId, uint16_t handle, uint8_t operation, uint16_t offset,
                         uint16_t len, uint8_t *pValue, attsAttr_t *pAttr)
{
    //APP_TRACE_INFO0(" ----------- secDatWriteCback ------------- \n\r");
...
{
    //APP_TRACE_INFO0(" ----------- datsPrivAddDevToResList ------------- \n\r");
    dmSecKey_t *pPeerKey;
...
{
    //APP_TRACE_INFO0(" ----------- datsPrivRemDevFromResListInd ------------- \n\r");
...
{
    //APP_TRACE_INFO0(" ----------- datsDisplayStackVersion ------------- \n\r");
...
{
    //APP_TRACE_INFO0(" ----------- datsRestoreResolvingList ------------- \n\r");
...
{
    //APP_TRACE_INFO0(" ----------- datsPrivAddDevToResListInd ------------- \n\r");
...
{
    //APP_TRACE_INFO0(" ----------- datsWsfBufDiagnostics ------------- \n\r");
...
{
    //APP_TRACE_INFO0(" ----------- btnPressHandler ------------- \n\r");
    if (btnId == 1) {
